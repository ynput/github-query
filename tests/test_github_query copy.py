...
@pytest.fixture
def pr_api_output_no_labels() -> List[dict[str, Any]]:
    with open("pr_api_output_no_labels.json") as file:
        return json.load(file)
    
@pytest.fixture
def pr_api_output_some_labels() -> List[dict[str, Any]]:
    with open("pr_api_output_some_labels.json") as file:
        return json.load(file)
...
def test_get_labels_no_labels(pr_api_output_no_labels: List[dict[str, Any]]) -> None:
